...
import java.util.Date;
	/**
	*此类由MySQL2Bean工具自动生成
	*备注(数据表的comment字段)：公司综合信息表
	*@author zhouxx
	*@since 2017-09-04 18:20:19
	*/

	public class TBusiPmultiplemsg	 extends BaseBean{
	...
	private Integer mtype;//1管理团队，2联系我们
	...
	private Date savetime;//最后一次操作的时间
		...
		public String getMbannerstr() {
			return mbannerstr;
		}

		public void setMbannerstr(String mbannerstr) {
			this.mbannerstr = mbannerstr;
		}
