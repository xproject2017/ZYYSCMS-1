...
<head>
    ...
    <script src="<s:url value="/webjs/industry/industrytendency.js"/>"></script>
    <script>
        ...
        <form role="form" class="form-inline" enctype="multipart/form-data" id="data_form">
            <div class="right-inblock-div">
                ...
                <c:if test="${bean.navigationid2==9}">
                    <div class="cell"><label>是否上热门产品：</label><input type="radio" name="mmsgc" value="0" checked/>否 <input type="radio" name="mmsgc" value="1"/>是 </div>
                </c:if>
