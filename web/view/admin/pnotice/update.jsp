    ...
    <div class="right-dy-data">
        ...
        <form role="form" class="form-inline" enctype="multipart/form-data" id="data_form">
            <div class="right-inblock-div">
                ...
                <div class="cell"><label>是否上公司公告：</label><input type="radio" name="mmsgc" value="0" <c:if test="${bean.mmsgc eq 0}">checked</c:if>/>否 <input type="radio" name="mmsgc" value="1" <c:if test="${bean.mmsgc eq 1}">checked</c:if>/>是 </div>
                ...
                <div class="cell"><a href="javascript:window.open('/view/getImage?navigationid1=${bean.navigationid1}&navigationid2=${bean.navigationid2}&mesgid=${bean.mesgid}')">点击查看原图</a></div>
