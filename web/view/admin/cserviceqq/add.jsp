    ...
    <div class="right-dy-data">
        ...
        <form role="form" class="form-inline" enctype="multipart/form-data" id="data_form">
            <div class="right-inblock-div">
                ...
                <div class="cell"><label>QQ：</label><input type="text" validrule="validate[required,maxSize[20]]" name="qq"></div>
                <div class="cell">
                    <label>客服名称：</label>
                    <input type="text" validrule="validate[required,maxSize[20]]" name="cname">
                </div>
