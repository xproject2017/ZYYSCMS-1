...
<head>
    ...
    <script src="<s:url value="/webjs/menu/menu.js"/>"></script>
    <script>
    ...
    <div class="right-dy-data">
        ...
        <form role="form" class="form-inline" enctype="multipart/form-data" id="data_form">
            <div class="right-inblock-div">
                ...
                <div class="cell"><label>菜单名称：</label><input type="text" validrule="validate[required]" name="nodetext" value="${bean.nodetext}"></div>
                <div class="cell" style="width: 70%"><label>菜单路径：</label><input type="text" style="width: 70%" name="path" value="${bean.path}" </div>
            </div>
            <input type="hidden" name="nodeid"  value="${bean.nodeid}"/>
            <input type="hidden" name="nodelevel" value="${bean.nodelevel}"/>
            <input type="hidden" name="nodecode" value="${bean.nodecode}"/>
