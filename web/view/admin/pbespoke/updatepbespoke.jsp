    ...
    <div class="right-dy-data">
        ...
        <form role="form" class="form-inline" enctype="multipart/form-data" id="data_form">
            <div class="right-inblock-div">
                ...
                <div class="cell"><label>预约人：</label>${bean.pbespokename}</div>
                <div class="cell"><label>手机号：</label>${bean.pbespokephone}</div>
                <div class="cell"><label>预约时间：</label>${bean.pbespoketimestr}</div>
                <div class="cell"><label>产品名称：</label>${bean.productname}</div>
            ...
            <input type="hidden" name="bespokeid" value="${bean.bespokeid}"/>
