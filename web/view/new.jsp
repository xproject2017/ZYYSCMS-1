...
<div class="middle-context">
    ...
    <div class="login-content">
        <form id="user_form" method="post">
            ...
            <div class="cell"><label>确认密码<span>*</span>：</label><input type="password" id="fagpword" maxlength="12"/></div>
            <div id="tips">&nbsp;</div>
            <div class="cell"><input type="button" value="注 册" onclick="registerValidatee()"/></div>
        </form>
    </div>
</div>
