      ...
      <div class="middle-context">
          ...
          <div class="right-div">
              ...
              <div class="about-main">
                  <c:choose>
                      <c:when test="${code==0}">
                          <div class="zx-div"><label>咨询内容：</label>${data.mes}</div>
                          <div class="zx-div"><label>姓名：</label>${data.consname}</div>
                          <div class="zx-div"><label>手机号：</label>${data.consphone}</div>
                          <div class="zx-div"><label>咨询时间：</label>
                              <fmt:formatDate value="${data.constime}" pattern="yyyy/MM/dd" />
                          </div>
